...
const pesan = ref({ jumlah_pemesanan: 0, keterangan: '', nama: '', id: '', gambar: '', harga: '', totalHarga: '' });
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active" aria-current="page"><span
                            class="fw-bold">{{ getProductById.nama }}</span> </li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <form @submit.prevent>
                        ...
                        <button class="btn btn-danger ms-3">
                            <router-link to="/foods" class="text-decoration-none text-white">
